...
Lo schema è denormalizzato: abbiamo aggregato le 5 tabelle relazionali (details, final_list, tags, images, related_videos) in un singolo documento per video, evitando il cartesian product dei join multipli. Questo riduce lo storage da oltre 500MB (con duplicazioni) a circa 20MB, rispettando il limite del piano free di MongoDB Atlas (512MB) e ottimizzando le query per lettura.
